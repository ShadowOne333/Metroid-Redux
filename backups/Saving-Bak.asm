...
;    GetSamusAttributesImpl:
;        ; This routine is copied to WRAM @ $7400
;        LDA MetroidOnSamus
;        BEQ +
;        LDA #$A1                ; Blue palette for when a metroid has you
;        .byte $2C ;             ; Skip following 2-byte instruction
;      * LDA ObjectCntrl
;        BIT SamusInFrontOfBg
;        BPL +
;        ORA #$80
;        *
;        RTS
    ...
    SaveGame:
        ...
        lda SamusInBoneyard             ; Remember if player is in boneyard 
        sta File_InBoneyard,X
    ...
    LoadGame:
        ...
        *
        ...
        lda File_InBoneyard,X           ; Load whether player is in boneyard
        sta SamusInBoneyard
        ...
        *
        ...
        ; Moved to expansion file (ran out of space again)
    ;BeepSound:
    ;    ; Beeps
    ;    LDA TriangleSFXFlag		
    ;    ORA #$08			
    ...
    CheckMenuUpDown:
        ...
        *
        ...
        bne +
            ...
            sta DeleteMode
            jsr SFX_BigEnemyHit ;   Play sound
...
; -----------------------------------------        
    ...
    FileItems_1:
        .byte $21, $45
        .byte $18
        .byte $D6, $D7, $FF, $D8, $D9, $FF, $DA, $DB, $FF, $DC, $DD, $FF, $DE, $DF, $FF, $E0, $E3, $FF, $E0, $E4, $FF, $E0, $E5, $FF
        .byte $21, $65
        .byte $18
        .byte $E6, $E7, $FF, $E8, $E9, $FF, $EA, $EB, $FF, $EC, $ED, $FF, $EE, $EF, $FF, $E1, $E2, $FF, $E1, $E2, $FF, $E1, $E2, $FF
        ; END PPU DATA
        .byte $00 
...
.endif
    ...
    .hex 3F 00 20
    .hex 0F 39 2A 19 0F 26 17 08 0F 0F 0F 0F 0F 0F 0F 0F
    .hex 0F 16 2B 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00
    
    ; 01 - Title Screen (flashing) (dark)
    .hex 3F 00 20 
    .hex 0F 39 2A 19 0F 26 17 08 0F 17 02 01 0F 30 02 01
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00
    
    ; 02 - Title Screen (flashing) (normal)
    .hex 3F 00 20 
    .hex 0F 39 2A 19 0F 26 17 08 0F 27 11 02 0F 30 11 02
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00
    
    ; 03 - Title Screen (flashing) (bright)
    .hex 3F 00 20 
    .hex 0F 39 2A 19 0F 26 17 08 0F 37 21 12 0F 30 21 12
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00
    ...
    .hex 3F 00 20
    .db $0f,$39,$2a,$19,$0f,$26,$17,$08,$0f,$08,$0f,$0f,$0f,$00,$0f,$0f
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00 
    
    ; 06 - Title Screen (fade-in)
    .hex 3F 00 20 
    .db $0f,$39,$2a,$19,$0f,$26,$17,$08,$0f,$08,$01,$0f,$0f,$00,$01,$0f
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00
    
    ; 07 - Title Screen (fade-in)
    .hex 3F 00 20 
    .db $0f,$39,$2a,$19,$0f,$26,$17,$08,$0f,$18,$02,$01,$0f,$10,$02,$01
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00 
    
    ; 08 - Title Screen (fade-in)
    .hex 3F 00 20
    .db $0f,$39,$2a,$19,$0f,$26,$17,$08,$0f,$18,$02,$02,$0f,$10,$02,$02
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00
    
    ; 09 - Title Screen (fade-in)
    .hex 3F 00 20 
    .db $0f,$39,$2a,$19,$0f,$26,$17,$08,$0f,$27,$12,$02,$0f,$20,$12,$02
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00 
    
    ; 0A - Title Screen (fade-in)
    .hex 3F 00 20
    .db $0f,$39,$2a,$19,$0f,$26,$17,$08,$0f,$27,$11,$02,$0f,$20,$11,$02
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00

    ; 0B - Game Over Screen
    .hex 3F 00 20 
    .hex 0F 10 1C 03 0F 30 11 02 0F 24 14 04 0F 34 24 14
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00

    ; 0C - Mission Pane (Normal) / File Menu [REPLACE WITH 0A FOR MISSION PANE]
    .hex 3F 00 20 
    .hex 0F 39 2A 19 0F 2B 27 16 0F 27 13 04 0F 30 21 12
    .hex 0F 16 2B 27 0F 01 21 11 0F 17 31 37 0F 32 22 12 00
    ...
    .hex 3F 00 20 
    .db $0f,$39,$2a,$19,$0f,$26,$17,$08,$0f,$18,$01,$0f,$0f,$10,$01,$0f
    .hex 0F 16 1A 27 0F 37 3A 1B 0F 17 31 37 0F 32 22 12 00 
    ...
    .hex 3F 00 20 
    .hex 06 39 2A 19 06 25 16 07 06 06 06 06 06 06 06 06
    .hex 06 16 1A 27 06 37 3A 1B 06 17 31 37 06 32 22 12 00
